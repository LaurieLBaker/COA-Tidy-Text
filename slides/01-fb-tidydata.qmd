...
```{r echo=FALSE, out.width="80%", fig.align="center", fig.cap = "Plot showing the vessel length and width as boats on a scatter plot where the size of the boat is proportional to the carrying capacity of the vessel"}
...
```{r echo=FALSE, out.width="80%", fig.align="center", fig.cap = "Plot showing the distribution of trip length by vessel"}
...
```{r echo=FALSE, out.width="80%", fig.align="center", fig.cap = "Plot showing the distribution of species in the catch by weight by vessel"}
...
<iframe src="https://navigating-change.netlify.app" width="1016" height="516" frameBorder="0"></iframe>

##  {background-image="figs/lizzieskipping.gif" background-size="70%" background-color="white"}
