...
* Visualize and map data using `ggplot` and `leaflet`
...
And then `separate_rows` so each location is on its own row
...
head(location_coordinates)

```

## We have `count` of how often Freeland visited that location
...
- Add 2 more sets of coordinates to the [location excel file](https://docs.google.com/spreadsheets/d/1vA5YjlsGHQBSmUOFsBpPSJhObK601zE3/edit?usp=sharing&ouid=104076949272458477636&rtpof=true&sd=true)
